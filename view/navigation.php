<!-- Navigation -->
<nav class="navbar navbar-expand-md navbar-light  sticky-top" style="background-color: #1d1c1c;">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
                <a class="nav-link" href="index2.php" style="color: white;">Accueil</a>
            </li>
            <li class="nav-item">
                <?php
                    if($_SESSION['role'] == 'etudiant')
                    {
                        echo ' <a class="nav-link" href="managebooking.php" style="color: white;">Réservations</a>';
                    }
                ?>
            </li>
            <li class="nav-item">
